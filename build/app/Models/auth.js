...
class auth extends Orm_1.BaseModel {
    static async hashPassword(auth) {
        if (auth.$dirty.password) {
            auth.password = await Hash_1.default.make(auth.password);
        }
    }
}
__decorate([
...
__decorate([
    Orm_1.column(),
    __metadata("design:type", String)
], auth.prototype, "rememberMeToken", void 0);
__decorate([
